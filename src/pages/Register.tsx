  ...
  return (
    <div className="pt-32 pb-24 min-h-screen flex items-center">
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto bg-white rounded-[24px] md:rounded-[40px] shadow-xl overflow-hidden flex flex-col lg:flex-row-reverse">
          {/* Form Side */}
          <div className="lg:w-1/2 p-8 md:p-12 lg:p-20">
            <div className="mb-8 md:mb-12">
              <h1 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">Create Account</h1>
              <p className="text-slate-500">Join Lumière and start your journey to radiant skin.</p>
            </div>
            ...
            <form className="space-y-6 mb-10">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input type="text" placeholder="Jane Doe" className="w-full bg-slate-50 border border-slate-100 rounded-2xl py-4 pl-12 pr-6 focus:outline-none focus:ring-2 focus:ring-primary-100 focus:border-primary-300 transition-all" />
                </div>
              </div>
              <div className="space-y-2">
          ...
          <div className="hidden lg:block lg:w-1/2 relative">
            <img 
              src="https://images.pexels.com/photos/3685530/pexels-photo-3685530.jpeg?auto=compress&cs=tinysrgb&w=800&h=1200" 
              alt="Beauty" 
              className="absolute inset-0 w-full h-full object-cover"
            />
            <div className="absolute inset-0 bg-primary-600/20 backdrop-blur-[2px]"></div>
            <div className="absolute bottom-12 md:bottom-20 left-8 md:left-20 right-8 md:right-20 text-white">
              <h2 className="text-5xl font-bold mb-6 leading-tight">Start Your <br /> Glow Journey</h2>
              <p className="text-xl text-white/90">Join thousands of others who have transformed their skincare routine with Lumière.</p>
            </div>
          </div>
        </div>
      </div>
