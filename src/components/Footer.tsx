    ...
    <footer className="bg-white pt-20 pb-10 border-t border-beige-200">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 mt-20 pt-8 border-t border-slate-100 flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <div className="flex gap-6 items-center">
          <img src="https://raw.githubusercontent.com/muhammedshokhene/creadit-card-logos/master/visa.png" alt="Visa" className="h-4 opacity-50 grayscale hover:grayscale-0 transition-all" />
          <img src="https://raw.githubusercontent.com/muhammedshokhene/creadit-card-logos/master/mastercard.png" alt="Mastercard" className="h-6 opacity-50 grayscale hover:grayscale-0 transition-all" />
